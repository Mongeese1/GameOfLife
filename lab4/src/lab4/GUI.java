...
class MouseEventTrapper implements MouseListener 
{
    ...
    // Add your code here
    // ...    
    public MouseEventTrapper(final TTTPanel panel, final TTTState state) {
    	this.panel = panel;
    	this.state = state;
    }
...
//it oly registers clicks when the mouse is not moving because it would need to implement 
    //the mouse motion listener class in order to be able to follow mouse movement
